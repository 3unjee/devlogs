...
- WControllerMedia: Added "source query" check.
- WControllerTorrent: Added "WHookTorrent" QML type.
- WAbstractHook: Added "backend" property.
- WApplication: Added "AbstractHook" QML type.
- WDeclarativePlayer: Added "hook" property.
- WTorrentEngine: Added "process alert" function.
...
[Youtube7]: http://youtube.com/watch?v=L6sqV5_NBxU
